...
export class PersonaService {
    ...
    public getPersonaFiltro(nombreCompleto) {
        return this.http.get(this.urlBase + "api/Persona/filtrarPersona/" + nombreCompleto).map(res => res.json());
    ...
    public listarPersonaCombo() {
        return this.http.get(this.urlBase + "api/Persona/listarPersonaCombo").map(res => res.json());
    }
